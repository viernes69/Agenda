...
<head>
  ...
  <style>
    ...
    .site-login-dropdown{position:absolute;top:calc(100% + 10px);right:0;width:max-content;min-width:280px;max-width:92vw;background:#fff;border:1px solid #e4e4f0;border-radius:14px;padding:18px;z-index:120;box-shadow:0 18px 40px -12px rgba(15,23,42,.18)}
